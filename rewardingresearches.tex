...
\begin{description}
  ...
  \item{$n$} : this is the number of BOINC projects in the whitelist [42]. Partecipants in whitelisted projects do receive a reward in gridcoins for their computational effort.  
\end{description}
