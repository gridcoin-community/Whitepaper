...
Gridcoin seeks to create a decentralized and sustainable distributed processing network which prioritizes both the utilization of IPP and the creation of a free host ecosystem for researchers and individuals with data to process.
...
BOINC, The Berkeley Open Infrastructure for Network Computing, is an open-source distributed processing network which provides scientists and enthusiasts with means to host computational data for free. BOINC has been operating since 2002 and has and continues to process data that helps map the Milky Way, detect potentially hazardous Near Earth Asteroids (NEOs), find prime numbers, fold proteins, test cures and vaccines, test chemical and molecular combinations, Search for Extraterrestrial Life (SETI) and more.\\
...
\begin{enumerate}
  ...
  \item Wait until the Gridcoin client manages to stake its first block with Proof of Stake and Proof of Research reward for your wallet.
\end{enumerate}
...
If users do not manage to get some starter coins, available from faucets, or if they lack the experience to buy them from exchanges, they have the possibility to join the Gridcoin Mining Pool [55]. Steps to become a pool miner are:
...
In a foreseable future, it will be possible to mine Gridcoins even on a user's smartwatch and on any computing device. If the Internet of Things becomes reality, maybe also on fridges and other electronic devices!
